...
class LoadMoreRecyclerViewEx : RecyclerView {
    ...
    fun setLoadMoreItem(loadMoreItem: IItem<LoadMoreState, ViewHolder>) {
    ...
    override fun setAdapter(adapter: Adapter<ViewHolder>?) {
        ...
        loadMoreAdapterEx = LoadMoreAdapterEx(adapter, loadMoreItem)
     ...
     * 加载更多 Adapter
     */
    private inner class LoadMoreAdapterEx(
        adapter: Adapter<ViewHolder>,
        private val loadMoreItem: IItem<LoadMoreState, ViewHolder>,
        override var loadMoreEnabled: Boolean = true
    ) : WrapperAdapter<LoadMoreItemDefault, ViewHolder>(adapter), ILoadMore {

        init {
            insertItems = listOf(loadMoreItem as LoadMoreItemDefault)
        }
